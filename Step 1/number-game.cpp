...
int main () {
    ...
    std::cin >> number; // Read user input and store it in the variable "tal"
    // std::cout << "you wrote: " << number << std::endl; // Print the value of "tal" to the console
    std::cout << "write a letter: "; // Print message to the console
    std::cin >> letter; // Read user input and store it in the variable "bokstav"
    // std::cout << "you wrote: " << letter << std::endl; // Print the value of "bokstav" to the console
    // std::cout << "write a name (string): "; // Print message to the console
    // std::cin >> name; // Read user input and store it in the variable "namn"
    // std::cout << "you wrote: " << name << std::endl; // Print the value of "namn" to the console
    ...
    // basic if-else statement using logical operators
